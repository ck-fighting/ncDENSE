...
Train_Data, Train_Label = Data_Create.train_data()#获取RNA碱基信息
Test_Data, Test_Label = Data_Create.test_data()#获取RNA标签信息
model = Model.densenet()#调用模型BI-GRU+AM+Densenet
...
optimer = optim.Adam(model.parameters(), lr=0.001)#优化器用于更新参数权重
